...
class Order(models.Model):
    ...
    ord_building = models.CharField(max_length=100, blank=True)
    ord_floor = models.CharField(max_length=50, blank=True)
    ord_room = models.CharField(max_length=50, blank=True)
    ord_supervisor = models.CharField(max_length=100, blank=True)
    ord_work_req = models.CharField(max_length=1000, blank=True)
    ord_work_ord = models.CharField(max_length=50, blank=True)
    ord_date_issue = models.DateField(null=True, blank=True)
